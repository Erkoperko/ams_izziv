...
test_model("/notebooks/AMS_izziv/pytorch-unet-segmentation-master/history/RMS/saved_models3/model_epoch_100.pwf",
           SEM_test_load, 100, "/notebooks/AMS_izziv/pytorch-unet-segmentation-master/history/RMS/result_images_test")
